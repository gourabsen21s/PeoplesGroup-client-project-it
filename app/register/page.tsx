            ...
            <div className="w-full lg:w-1/2 px-4 mb-12 lg:mb-0">
              <div className="max-w-md mx-auto">
                <div className="mb-8 text-center lg:text-left">
                  ...
                  <h1 className="font-heading text-4xl sm:text-5xl mb-4">Create an account</h1>
                  <p className="text-gray-700">Join us in creating a greener future</p>
                </div>
                <form>
                  <div className="mb-6">
                  ...
                  <div className="mb-6">
                    <label className="flex items-start">
                      ...
                      <span className="text-sm">
                        I agree to the{" "}
                        <a href="#!" className="text-teal-900 hover:text-teal-700">
                  ...
                  <p className="text-center text-sm text-gray-700 mt-6">
                    ...
                    <Link href="/login" className="text-teal-900 hover:text-teal-700 font-medium">
                      Sign in
                    </Link>
                  </p>
                </form>
            ...
            <div className="w-full lg:w-1/2 px-4">
              <div className="relative">
                <Image
                  ...
                  src="/fauna-assets/sign-in/circle-photos-teal.png"
                  alt="Register"
                  width={600}
                  height={600}
                />
